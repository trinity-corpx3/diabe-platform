import{r as y,j as s}from"./react-C-6650bX.js";import{a9 as k,aa as p,r as h,e as x,$ as C,aG as A,eI as w,ah as d,U as l,ai as B,aj as u,ak as m,f as E}from"./index-DwXjzTLP.js";import{u as _}from"./react-query-CoI1znE-.js";import{c as S}from"./jotai-Ca2bzGWW.js";import{$ as T,a7 as I,O,R,Q as $}from"./react-icons-CvaiBonm.js";import{u as b}from"./react-i18next-mqyEDb_3.js";import{d as M,a as P}from"./react-router-Dm3tNMtk.js";/**
 ...
 */function Q(){const a=_(),t=S(k);return async(o,i)=>(p.processing(),h("POST",x("/api/v1/designs/bulk"),{action:i,ids:o}).then(()=>{p.success(`${i}d_design`),C(["designs"]),t&&a.invalidateQueries([t])}))}/**
 * Invoice Ninja (https://invoiceninja.com).
 *
 * @link https://github.com/invoiceninja/invoiceninja source repository
 *
