import{o as ir}from"./@babel-C6hKJqrj.js";import{b as cr}from"./react-CDYlDoz2.js";var L={};/*! For license information please see index.js.LICENSE.txt */var K;function lr(){return K||(K=1,function(Y){(()=>{var G={184:(n,i)=>{var c;(function(){var u={}.hasOwnProperty;function s(){for(var o=[],l=0;l<arguments.length;l++){var a=arguments[l];if(a){var m=typeof a;if(m==="string"||m==="number")o.push(a);else if(Array.isArray(a)){if(a.length){var j=s.apply(null,a);j&&o.push(j)}}else if(m==="object"){if(a.toString!==Object.prototype.toString&&!a.toString.toString().includes("[native code]")){o.push(a.toString());continue}for(var w in a)u.call(a,w)&&a[w]&&o.push(w)}}}return o.join(" ")}n.exports?(s.default=s,n.exports=s):(c=(function(){return s}).apply(i,[]))===void 0||(n.exports=c)})()},28:(n,i,c)=>{c.d(i,{Z:()=>a});var u=c(81),s=c.n(u),o=c(645),l=c.n(o)()(s());l.push([n.id,`/* :where() gives the styles specificity 0, which makes them overridable */
:where(.vi__wrapper) {
  position: relative;
  width: min-content;
}
