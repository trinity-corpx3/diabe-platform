...
Route::group(['middleware' => ['throttle:api', 'token_auth', 'valid_json', 'locale'], 'prefix' => 'api/v1', 'as' => 'api.'], function () {
    ...
    Route::post('office_expenses/bulk', [OfficeExpenseController::class, 'bulk'])->name('office_expenses.bulk');
    ...
    Route::get('proveedores-saldo', [\App\Http\Controllers\ProveedoresSaldoController::class, 'index'])->name('proveedores_saldo.index');
